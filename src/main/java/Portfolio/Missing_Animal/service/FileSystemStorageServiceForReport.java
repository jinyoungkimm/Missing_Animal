...
@Service
@Slf4j
public class FileSystemStorageServiceForReport implements StorageServiceForReport {

    private final Path rootLocation; // rootLoacation == upload-dir-Report

    @Autowired
    public FileSystemStorageServiceForReport(StoragePropertiesForReport properties) {
