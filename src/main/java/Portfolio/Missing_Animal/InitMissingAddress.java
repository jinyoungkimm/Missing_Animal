   ...
   private final EntityManager em;
    ...
    public void init(){
       ...
       // createRegister(missingAddress1, "김진영2","사랑이2");
        ...
        createRegister(missingAddress1, "김진영1","사랑이1","사랑이2");
       ...
       // createRegister(missingAddress3, "김진영4","사랑이4");
        createRegister(missingAddress3, "김진영2","사랑이3","사랑이4");
       ...
       // MissingAddress missingAddress6 = createMissingAddress("전라남도","1-3-2","전주시2","전주구2","천주동2","전주대로1_2");
        ...
        createRegister(missingAddress5, "김진영3","사랑이5","사랑이6");
        ...
        createRegister(missingAddress7, "김진영4","사랑이7","사랑이8");
    }
    public  void createRegister(MissingAddress missingAddress,String userName,String animalName1,String animalName2) {
